...
class WikiHouse::GrooveConnector < WikiHouse::Connector
  attr_reader :rows, :depth_in_t

  def initialize(depth_in_t: 0, length_in_t: nil, count: 1, width_in_t: nil, thickness: nil, rows: 1)
    if depth_in_t >= 1
  ...
  def draw_groove!(location: nil, fillet_off: false)
    ...
    groove_lines = [c5c6,
                    ...
                    c7c11,
                    c8c12]
    groove_face = Sk.add_face([c9,c10,c11,c12])
